...
def emailrequester(miq_request, ui_vip)
  ...
  body += "<br><br>To view this Request go to: <a href='https://#{ui_vip}/miq_request/show/#{miq_request.id}'>https://#{ui_vip}/miq_request/show/#{miq_request.id}</a>"
...
def emailapprover(miq_request, ui_vip)
  $evm.log('info', "Requester email logic starting")
...
# Email Requester
emailrequester(miq_request, ui_vip)
