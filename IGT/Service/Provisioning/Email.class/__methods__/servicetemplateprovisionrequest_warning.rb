...
def approver_text(ui_vip, requester_email, msg)
  body = "Approver, "
  ...
  body += "<br><br><a href='https://#{ui_vip}/miq_request/show/#{@miq_request.id}'</a>"
...
def email_approver(ui_vip, msg)
  ...
  send_mail(to, from, subject, approver_text(ui_vip, requester_email_address, msg))
end
...
def requester_text(ui_vip, msg)
  ...
  body += "<br>#{msg}."
  body += "<br><br>For more information you can go to: "
  body += "<br><br><a href='https://#{ui_vip}/miq_request/show/#{@miq_request.id}'"
